...
<body class="hold-transition login-page newbg">
  ...
  <style>
    body{
      background-image: url("../uploads/newbg.png");
  ...
  <img src="<?php echo validate_image($_settings->info('logo')) ?>" class="d-inline-block align-top titlelogo" alt="" loading="lazy" style="max-height: 80px;">
  <h1 class="text-center logintitle px-4"><b>Pixster</b></h1>
